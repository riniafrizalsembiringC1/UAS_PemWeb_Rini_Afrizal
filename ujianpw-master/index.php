...
<div id="app">
  ...
  <aside class="aside is-placed-left is-expanded">
    ...
    <div class="menu is-menu-main">
      ...
      <ul class="menu-list">
        <li>
          <a href="?page=mahasiswa" class="has-icon">
  ...
  <?php
    if(isset($_GET['page']))
    {
      switch($_GET['page'])
      {
        case 'home' : include("./pages/datamhs.php");break;
        case 'mahasiswa': include("./pages/datamhs.php");break;
        case 'create-mahasiswa': include("./pages/createmhs.php");break;
        case 'edit-mahasiswa': include("./pages/createmhs.php");break;
        case 'success': include("./pages/success.php");break;
        case '' : include("./pages/datamhs.php");break;
        default : include("./pages/datamhs.php");break;
      }
    }
    else
    {
      include("./pages/datamhs.php");
    }
  ?>
  <footer class="footer">
